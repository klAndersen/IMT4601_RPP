...
whether the party was a human or a computer ([p.~2]\cite{Russell2013}).}. It would also be interesting to look more deeply into the \gls{ai} algorithms, 
...
\vspace{0.5em}\newline
One example is the paper by \cite{Crutzen2011} were they used an existing ChatBot called Bzz for answering adolescents' questions related to sex, drugs and alcohol. Their study showed 
...
[p.~516]\cite{Crutzen2011}.}, and that the users felt it was faster and better then information lines and search engines. \cite{Knill2004} says that a ChatBot can be easier to converse 
...
\vspace{0.5em}\newline
\cite[p.~268]{Kowalski2013} did two case studies where they compared the use of ChatBots and e-learning in relation to Information Security. They measured the ChatBot experience 
...
ChatBot and those using e-learning. CSIEC (documented in \cite{Jia2009}) is a ChatBot developed for learning english, and was tested in \cite{Jia2008}. The students achieved a very 
...
It is therefore in my opinion safer to go with \gls{hmm} and \gls{bn}, to ensure completion of the thesis.
\vspace{0.5em}\newline
