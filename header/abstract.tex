...
it (e.g. trying to humanize the Chat Agent (Turing Test)). An example of the experiment would be to have two test groups (Random Controlled Trial (RCT)), where the comparison would be on 
the grades of 
